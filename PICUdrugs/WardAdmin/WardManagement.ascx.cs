...
namespace PICUdrugs.websiteAdmin
{
    public partial class WardManagement : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //add css
            containingMaster.CreateStyle("~/CSS/WardManagement.css");
            //add javascript file
        ...
        public bool AutoPostBack
        {
            set
            {
                DptDropDownList.AutoPostBack = value;
            }
            get
            {
                return DptDropDownList.AutoPostBack;
            }
        }
        ...
        protected void DptDropDownList_PreRender(object sender, EventArgs e)
        {
            ...
            dptDetailView.AutoGenerateEditButton = CanModifySelectedWard;
            bool canInsertDelete = CurrentUser.Roles.Contains("websiteAdmin");
            dptDetailView.AutoGenerateInsertButton = canInsertDelete;
            dptDetailView.AutoGenerateDeleteButton = canInsertDelete;
        }
    }
}