...
<fieldset ID="roleDetails" runat="server">
    ...
    <asp:CheckBox runat="server" ID="websiteAdmin" Text="Manage users and permissions" /><br />
    <asp:CheckBox runat="server" ID="drugAdmin" Text="Create and modify drugs"  /><br />
    <asp:CheckBox runat="server" ID="wardAdmin" Text="Select Infusions for a specific Ward" />
