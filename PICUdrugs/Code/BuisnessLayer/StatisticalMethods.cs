...
namespace PICUdrugs.DAL
{
    ...
    public partial class CdcBmiForAge : StatisticalData
    { }
    public partial class CdcWeightForAge : StatisticalData
    { }
    public partial class CdcLengthForAge : StatisticalData
    { }
    public class Distribution : StatisticalData
    {
...
namespace PICUdrugs.BLL
{
    ...
    public static class StatisticalDataExtensions
    {
        ...
        public static string CentileToString(double centile, bool asHtml=false, string centileText=" centile")
        {
            string returnVal;
            if (centile < 1) { returnVal = (asHtml) ? "&lt;1<sup>st</sup>" : "<1st"; }
            else if (centile > 99) { returnVal = (asHtml) ? "&gt;99<sup>th</sup>" : ">99th"; }
    ...
    {
        /// <summary>
        /// returns an approximation of the cumulative standard normal distribution 
        /// </summary>
        /// <param name="Zscore">Z statistic</param>
        /// <returns>Cumulative distribution 0 - 1</returns>
