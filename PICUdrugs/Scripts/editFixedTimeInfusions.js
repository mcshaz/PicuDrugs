(function ($) {
    ...
    function calcRate4Vol(argObj, isPerHr) {
        ...
        // //(isPerHr ? 1:60) needs to be worked out. however, for levo and NAC both work with what is below - need to get my head into logic later
        var rate = (conc * vol * 60 / argObj.calcDuratn); 
